    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bids_audit_logs', to='accounts.customuser')),
            ],
            options={
                'ordering': ['-timestamp'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bidder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bids_submitted_bids', to='accounts.customuser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bids_evaluation_responses', to='accounts.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Contract',
            fields=[
                ...
                ('signed_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bids_signed_contracts', to='accounts.customuser')),
